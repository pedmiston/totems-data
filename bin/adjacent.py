...
inventories[['ID', 'NumAdjacent']].to_csv('data-raw/num-adjacent.csv', index=False)
...
adjacent_inventories[['ID', 'Adjacent']].to_csv('data-raw/adjacent-items.csv', index=False)
